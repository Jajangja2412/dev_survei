...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <h2 class="text-center"><b>Tambah Pedoman Survei Visi dan Misi</b></h2>
                <form action="/simpan-pedoman-survei-vm" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="/upload-pedoman-survei-vm" class="btn btn-secondary">Kembali</a>
                </form>
            </div>
        </div>
    </div>
