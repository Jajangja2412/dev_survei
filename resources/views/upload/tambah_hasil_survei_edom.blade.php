...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <h2 class="text-center"><b>Tambah Hasil Survei Evaluasi Dosen Oleh Mahasiswa</b></h2>
                <form action="/simpan-hasil-survei-edom" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="/upload-survei-edom" class="btn btn-secondary">Kembali</a>
                </form>
            </div>
        </div>
    </div>
