...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <h2 class="text-center"><b>Tambah Pedoman Survei LPPM</b></h2>
                <form action="/simpan-pedoman-survei-lppm" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="/upload-pedoman-survei-lppm" class="btn btn-secondary">Kembali</a>
                </form>
            </div>
        </div>
    </div>
